...
import 'package:sazones_semanales/infrastructure/services/speech_recognition_service_windows_impl.dart';
...
class SpeechRecognitionServiceFactory {
  ...
  enum SpeechRecognitionImplementation {
    ...
    /// Implementación de Windows Speech Recognition
    windowsApi,
  ...
  static SpeechRecognitionImplementation _currentImplementation = _getDefaultImplementation();
  ...
  static SpeechRecognitionImplementation _getDefaultImplementation() {
    if (Platform.isAndroid || Platform.isIOS) {
      ...
      return SpeechRecognitionImplementation.whisper; // Cambiado a whisper por defecto
    } else {
  ...
  static void setImplementation(SpeechRecognitionImplementation implementation) {
  ...
  static SpeechRecognitionService create(BuildContext context) {
    ...
    switch (_currentImplementation) {
      ...
      case SpeechRecognitionImplementation.windowsApi:
        if (Platform.isWindows) {
          return SpeechRecognitionServiceWindowsImpl(context);
        } else {
  ...
  static Future<void> _checkWhisperFilesAndFallback(BuildContext context) async {
    final platformConfig = PlatformConfig();
    ...
    if ((!modelAvailable || !binaryAvailable) && platformConfig.useCloudFallback) {
